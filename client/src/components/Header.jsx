...
console.log(error.message);
  ...
  return (
    <Navbar className="bg-white px-2 py-2.5 dark:border-gray-700 dark:bg-gray-800 sm:px-4 border-b-2 flex justify-between items-center ">
      ...
      <Button className="w-12 h-10 lg:hidden flex justify-center items-center rounded-xl  dark:bg-gray-700">
  <AiOutlineSearch className="text-xl dark:text-white " /> {/* Increase the size of the icon */}
</Button>
        ...
        {showDropdown && (
          <div className="absolute bg-white dark:bg-gray-700 top-full left-0 mt-1 w-40 py-2 rounded-lg shadow-lg">
            <Link to="/" className="block px-4 py-2 
             dark:text-white dark:bg-gray-700 text-gray-800 dark:hover:bg-gray-900 hover:bg-gray-200">Home</Link>
            <Link to="/about" className="block px-4 py-2 
             dark:text-white dark:bg-gray-700 text-gray-800 dark:hover:bg-gray-900 hover:bg-gray-200">About</Link>
            <Link to="/projects" className="block px-4 py-2 
             dark:text-white dark:bg-gray-700 text-gray-800 dark:hover:bg-gray-900 hover:bg-gray-200">Projects</Link>
          </div>
        )}
      </div>
