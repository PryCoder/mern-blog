...
export default function DashProfile() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Implement your update logic here, including imageFile if needed
    console.log("Form submitted!");
  };

  // Check if currentUser is defined before accessing profilePicture
  const profilePicture = currentUser ? currentUser.profilePicture : null;

  return (
    <div className='max-w-ig mx-auto p-3 w-full'>
